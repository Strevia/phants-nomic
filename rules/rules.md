...
11. Heroes have four main stats between 1-5, BDY (Body) MAG (Magic) DEF (Defense) SPD (Speed). When a new hero object is created it has 15 XP to allocate among those four stats, the first and second rank take 1 XP, the theird and fourth rank take 2 XP, and the fith rank takes 3 XP to purchace. Heroes Name's can be any combonation between Three and Twenty alphanumberic characters. Heroes start at level 1 and with 10 HP plus their Body.   
