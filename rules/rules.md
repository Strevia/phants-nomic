...
12. Heroes have four main stats between 1-5, BDY (Body) MAG (Magic) DEF (Defense) SPD (Speed). When a new hero object is created it has 15 XP to allocate among those four stats, the first and second rank take 1 XP, the third and fourth rank take 2 XP, and the fifth rank takes 3 XP to purchase. Heroes Names can be any combination between Three and Twenty alphanumeric characters. Heroes start at level 1 and with 10 HP plus their Body.